      ...
      >
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.trustRow}>
              <View style={styles.trustPill}>
                ...
                <Text style={styles.trustText}>Saugus prisijungimas</Text>
              </View>

              <View style={styles.trustPill}>
                <Ionicons name="chatbubble-ellipses" size={16} color={COLORS.primary} />
                <Text style={styles.trustText}>Greiti pranešimai</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.cardHint}>Įvesk prisijungimo duomenis, kad tęstum.</Text>
            ...
            <View style={styles.field}>
              ...
              <View style={styles.inputWrap}>
                <Ionicons name="lock-closed-outline" size={18} color="rgba(226,232,240,0.85)" style={styles.leftIcon} />
                <TextInput
            ...
            <Text style={styles.legal}>
              Tęsdami sutinkate su taisyklėmis ir privatumo politika.
            </Text>
          </View>
        </View>
      </LinearGradient>
...
const styles = StyleSheet.create({
  ...
  logoBadge: { width: '100%', alignItems: 'center' },
  logoImage: {
    width: 300,
    height: 200,
    marginBottom: -50,
  ...
  footerLink: { color: COLORS.primary2, fontWeight: '900' },
